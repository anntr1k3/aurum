...
├── tests/
│   └── Aurum.Core.SelfTests/           # 38 автономных модульных и интеграционных тестов
...
* **Возможности:**
  * Каталог из **24 проверенных системных твиков** в 8 категориях (`Проводник`, `Интерфейс`, `Игры`, `Конфиденциальность`, `Ввод`, `Система`, `Ядро`, `Сеть`).
  ...
  * 4 профиля: `balanced`, `gaming`, `privacy`, `laptop`.
...
### 1. Запуск всех тестов (38 тестов):
```powershell
