...
description: "Reliable command execution on Windows: quoting paths with spaces, PowerShell redirection and encoding pitfalls, dotnet CLI flags, and long-path limits. Use when running or debugging PowerShell, CMD, or dotnet commands on Windows."
---

# Windows Shell Reliability Patterns

> Vendored from sickn33/agentic-awesome-skills. See ../README.md for attribution.
