...
public interface IServiceControlStore
{
    ...
    Task ChangeStartModeAsync(string serviceName, ServiceStartMode startMode, CancellationToken cancellationToken = default);
...
public sealed class ServiceManager
{
    ...
    public async Task DisableServiceAsync(string serviceName, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            try
            {
                await _controlStore.ChangeStartModeAsync(serviceName, ServiceStartMode.Disabled, cancellationToken);
            ...
            catch (Exception ex)
            {
                try
                {
                    await _controlStore.ChangeStartModeAsync(serviceName, entry.OriginalStartMode, CancellationToken.None);
    ...
    public async Task RevertServiceAsync(string serviceName, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            await _controlStore.ChangeStartModeAsync(serviceName, entry.OriginalStartMode, cancellationToken);
