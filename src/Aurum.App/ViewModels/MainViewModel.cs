...
public sealed class MainViewModel : ObservableObject, IDisposable
{
    ...
    private void BuildSimpleFeatures()
    {
        ...
        SimpleFeatures.Add(new SimpleFeatureItemViewModel(
            ...
            async () =>
            {
                await RevertTweakByIdAsync(TweakIds.Gaming.DisableBackgroundCapture);
                await RevertTweakByIdAsync(TweakIds.Gaming.DisableXboxGameBar);
                return true;
            },
            ReportStatus));
        ...
        SimpleFeatures.Add(new SimpleFeatureItemViewModel(
            ...
            async () =>
            {
                await Storage.OptimizeAllSsdDirectAsync();
                return true;
            },
        ...
        SimpleFeatures.Add(new SimpleFeatureItemViewModel(
            ...
            async () =>
            {
                await ApplyTweakByIdAsync(TweakIds.Privacy.DisableAdvertisingId);
                await ApplyTweakByIdAsync(TweakIds.Privacy.DisableFeedbackRequests);
                await ApplyTweakByIdAsync(TweakIds.Privacy.DisableTailoredExperiences);
                await ApplyTweakByIdAsync(TweakIds.Privacy.DisableSearchWebResults);
                return true;
            },
            async () =>
            {
                await RevertTweakByIdAsync(TweakIds.Privacy.DisableAdvertisingId);
                await RevertTweakByIdAsync(TweakIds.Privacy.DisableFeedbackRequests);
                await RevertTweakByIdAsync(TweakIds.Privacy.DisableTailoredExperiences);
                await RevertTweakByIdAsync(TweakIds.Privacy.DisableSearchWebResults);
                return true;
            },
            ReportStatus));
