...
public sealed class StorageViewModel : ObservableObject
{
    ...
    public async Task<bool> OptimizeAllSsdDirectAsync()
    {
        ...
        {
            await RunOperationAsync(StorageOperationKind.Retrim, vol);
        }
        return true;
    }
    ...
    private async Task RunOperationAsync(StorageOperationKind operation, StorageVolumeItemViewModel volume)
    {
        IsBusy = true;
