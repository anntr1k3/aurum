...
public sealed class WindowsStorageTuningStore : IStorageTuningStore
{
    ...
    public async Task SetSysMainDisabledAsync(bool disabled, CancellationToken cancellationToken = default)
    {
        ...
        if (disabled)
        {
            await _serviceStore.ChangeStartModeAsync("SysMain", ServiceStartMode.Disabled, cancellationToken);
            try
            {
        ...
        {
            await _serviceStore.ChangeStartModeAsync("SysMain", ServiceStartMode.Automatic, cancellationToken);
            try
            {
